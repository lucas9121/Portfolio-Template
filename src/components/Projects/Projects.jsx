...
import { FaCss3Alt, FaBootstrap, FaExternalLinkAlt, FaHtml5, FaNodeJs, FaGitAlt } from 'react-icons/fa';
                            ...
                            <div className="game-description">
                                ...
                                <div className="project-links-container">
                                    <ul className='project-links'>
                                        ...
                                        {project.liveLink && <li><a className={props.toggle ? "link-dark-mode" : "link"} href={project.liveLink} target="_blank" rel="noreferrer"><FaExternalLinkAlt id="external-icon" className="icon" /></a></li>}
                                    </ul>
                                </div>
                            </div>
                        </article>
